...
const Ruler = () => {
    ...
    if ((isDraggingLeft || isDraggingRight) && rulerRef.current) {
      ...
      if (container) {
        ...
        if (isDraggingLeft) {
          ...
          const newLeftPostition = Math.min(rawPosition, maxLeftPosition);
          setLeftMargin(newLeftPostition);
  ...
  return (
    <div
      ...
      className="h-6 border-b border-gray-300 flex items-center relative select-none print:hidden"
    >
      <div
        id="ruler-container"
                ...
                >
                  {marker % 10 === 0 && (
                    <>
                      ...
                      <span className="absolute bottom-2 text-[10px] text-neutral-500 transform -translate-x-0.5">
                        {marker / 10 + 1}
                      </span>
                    </>
                  )}
