                ...
                return (
                  <div
                    ...
                    className={`w-6 h-6 border border-gray-300 cursor-pointer transition-colors ${
                      isSelected ? 'bg-blue-500 border-blue-600' : // Sélection confirmée (bleu foncé)
                      isHovered ? 'bg-blue-200 border-blue-300' :  // Survol (bleu clair)
                      'bg-white hover:bg-gray-100'                   // Normal (blanc)
                    }`}
